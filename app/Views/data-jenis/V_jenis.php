    ...
    <div class="modal fade" id="modal-default">
        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content">
                ...
                <form method="post" action="Add-jenis" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kd_jenis" class="form-control" placeholder="Kode Jenis" required>
                                </div>
                                <div class="form-group">
                                        ...
                                        <td>
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <form action="<?= base_url('/Data-jenis/update/') . $row['id_jenis']
                                                                    ?>" method="post">
                                                        <?= csrf_field();
                                                        ?>
                                                    ...
                                                    <form action="<?= base_url('delete-jenis/') . $row['id_jenis'] ?>" method="post">
                                                        <?= csrf_field();
                                                        ?>
