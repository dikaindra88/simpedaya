...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Report Dana Keluar</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Halaman</a></li>
                        <li class="breadcrumb-item active">Report Dana Keluar</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->

            <hr>
            <form action="Search-keluar" method="POST" enctype="multipart/form-data">
                <div class="row ml-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <a href="<?= base_url('Print/keluar') . '/' . $first_date . '/' . $end_date . '/' . $id_satuan ?>" target="_blank" class="btn btn-outline btn-danger ">
                                <i class="fas fa-file-pdf"></i> Pdf
                            </a>
                            <a href="<?= base_url('Print-keluar') . '/' . $first_date . '/' . $end_date . '/' . $id_satuan ?>" target="_blink" class="btn btn-outline-secondary btn-light">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-condensed " id="example3">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr class="text-center" style="padding: 5%; font-size: 9pt;">
                                    <td colspan="7">Total Dana Keluar</td>
