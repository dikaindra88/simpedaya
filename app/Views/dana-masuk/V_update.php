...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Update Data Dana Masuk</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Halaman</a></li>
                        <li class="breadcrumb-item active">Update Data Dana Masuk</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="/Edit-masuk/<?= $in[0]['id_masuk'] ?>" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="id_donatur" data-placeholder="Select Nama Donatur" class="form-control select2bs4" required>
                                            <option value="<?= $in[0]['id_donatur'] ?>" selected><?= $in[0]['nama_donatur'] ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kd_jenis" data-placeholder="Pilih Jenis Dana" class="form-control select2bs4" required>
                                            <option value="<?= $in[0]['kd_jenis'] ?>" selected><?= $in[0]['jenis'] ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dana_masuk" value="<?= $in[0]['dana_masuk'] ?>" class="form-control" placeholder="Jumlah Dana Masuk" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Satuan</label>
                                        <select name="id_satuan" data-placeholder="Pilih Satuan" class="form-control select2bs4" required>
                                            <option value="<?= $in[0]['id_satuan'] ?>" selected><?= $in[0]['satuan'] ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keterangan" value="<?= $in[0]['keterangan'] ?>" class="form-control" placeholder="Keterangan" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Approved</label>
                                        <select name="id_approve" data-placeholder="Pilih Approve" class="form-control select2bs4" required>
                                            <option value="<?= $in[0]['id_approve'] ?>" selected><?= $in[0]['approve'] ?></option>
                                    ...
                                    <div class="form-group">
                                        <div class="file-upload">
                                            ...
                                            <div class="file-upload-content1">
                                                <center><img class="file-upload-image1" width="100px" height="100px" src="<?= '../../bukti-tf/' . $in[0]['bukti_tf'] ?>" alt="your image" /></center>
