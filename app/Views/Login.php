...
<body class="hold-transition login-page" style="background-image:url(<?php echo base_url('img/background.jpg') ?>);background-size:cover;">
    <div class="login-box">
        <div class="login-logo">

            <a href="/Login-admin"><b style="color:azure;">Admin CBN</b></a>
