...
<body>
    ...
    <hr />
    <p style="font-weight:bold;font-size:12pt;font-family:Arial, Helvetica, sans-serif;" align="center">REPORT DATA DONATUR</p>
    <table style="border:1px solid #000;border-collapse: collapse;" width="100%" cellpadding="0">
        <thead>
            <tr class="bg-secondary text-center" style=" font-size: 8pt; background-color:#999; color:white;border:1px solid #000;">
                ...
                <th style="width: 10%;">Nama Donatur</th>
        ...
        font-family: Arial, Helvetica, sans-serif;">
                    ...
                    <td style="border:1px solid #000;padding: 2px;"><?= $rows['usia'] ?></td>
                    <td style="border:1px solid #000;padding: 2px;"><?= $rows['status'] ?></td>
                    <td style="border:1px solid #000;padding: 2px;"><?= $rows['alamat'] ?></td>
                    </div>
                </tr>
            <?php endforeach ?>
